...
Each collection is CLEARED and rewritten on every sync, so a file you add to one disappears on the next run.

## Everything else is yours

Layouts, styles, pages, `Gemfile` - the theme - are never rewritten. Change them freely.
